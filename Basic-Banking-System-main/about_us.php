...
<body style="background-color:#FAEB6C;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Abhijeet bhingole</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> Dr.Babasaheb Ambedkar technological University</b></p>
    </center>
